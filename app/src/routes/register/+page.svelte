...
<svelte:head>
	<title>Sign Up - Bookmarker</title>
</svelte:head>
...
<div class="min-h-screen bg-background flex items-center justify-center p-4">
	<div class="w-full max-w-md space-y-8">
		...
		<div class="text-center space-y-2">
			...
			<p class="text-muted-foreground">Start organizing your bookmarks today</p>
		</div>
		...
		<Card class="p-8">
			...
			<div class="mt-6 text-center">
				<p class="text-sm text-muted-foreground">
					...
					<a href="/login" class="font-medium text-primary hover:text-primary/80 underline underline-offset-2">
						Sign in here
					</a>
				</p>
			</div>
